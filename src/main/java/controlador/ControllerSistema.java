...
public class ControllerSistema {
	...
	*/
	...
	public void crearNuevoUsuario(Integer idUsuario, String nombre, String direccion, Integer dni, String categoria, String condicionIva, String contraseña) {
		
		Usuario nuevoUsuario = new Usuario(idUsuario, nombre, direccion, dni, categoria, condicionIva, contraseña);
